...
export { DEPLOYMENT_ID_HEADER, PARENT_SPAN_ID_HEADER, REQUEST_ID_HEADER, RESPONSE_TIME_HEADER, SERVED_BY_HEADER, TRACE_ID_HEADER, addTracingHeaders, configureLogger, createDebugConfigHandler, createDebugInfoHandler, createHealthHandler, createLogger, createTracedClient, generateRequestId, generateTraceId, getBuildInfo, getCachedBuildInfo, getDebugConfig, getDebugInfo, getLogger, getParentSpanId, getRequestId, getTraceContext, getTraceHeaders, getTraceId, parseTraceContextFromHeaders, parseTraceId, runHealthChecks, runWithTraceContext, tracedFetch, withTracing };
